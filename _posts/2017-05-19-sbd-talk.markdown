...
<li>Adapt entity-oriented schema to column store</li>
 <ul>
 <li>Use columm per predicate when possible</li>
 <li>Use repeated columns instead of secondary table</li>
 <li>No reverse tables</li>
 </ul>
<li>Current status: schema implemented</li>
 <ul>
...
<li>Semantic big data means reasoning</li>
 ...
 <li>would lover others to get involved</li>
 </ul>
<li>Reasoning is not necessarily DL</li>
 <ul>
 <li>explore SPARQL entailment regimes</li>
 <li>explore alternate logics</li>
 </ul>
</ul>
</section>
