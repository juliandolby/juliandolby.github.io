...
public class TaintAnalysis {
	...
	public static EndpointFinder<Statement> documentWriteSink = new EndpointFinder<Statement>() {
		@Override
	...
	public static EndpointFinder<Statement> documentUrlSource = new EndpointFinder<Statement>() {
		@Override
		public boolean endpoint(Statement s) {
